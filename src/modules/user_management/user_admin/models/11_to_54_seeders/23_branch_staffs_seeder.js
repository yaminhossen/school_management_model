...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        let data = [];
        function set_data(id,user_staff_id, status,branch_id,possition,joining_date,department) {
            data.push({
                id,
                user_staff_id,
                status,branch_id,possition,joining_date,department,
                created_at:'2024-02-14',
                updated_at:'2024-02-14',
            })
        }
        // set_data(1,22, 'active',21,'junior','2024-02-14','marketing');
        set_data(1,11, 'block',11,'senior','2024-03-15','english');
