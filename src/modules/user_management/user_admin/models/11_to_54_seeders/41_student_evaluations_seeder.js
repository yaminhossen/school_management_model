...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        let data = [];
        function set_data(id,branch_id,branch_student_id,student_evaluation_criteria_id,score) {
            data.push({
                id,branch_id,branch_student_id,student_evaluation_criteria_id,score,
